...
public class MoviesCollectionContentProvider extends ContentProvider {
    // used to access the database
    private MoviesCollectionDatabaseHelper dbHelper;
    ...
    public boolean onCreate() {
        ...
        dbHelper = new MoviesCollectionDatabaseHelper(getContext());
